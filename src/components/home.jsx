...
const reviews = [
  {
    name: "Ravi Menon",
    comment: "We recently got our swimming pool installed and the entire experience was smooth and professional. Right from the design stage to execution, the team was responsive and explained everything patiently. The final result exceeded our expectations. Our kids love the pool, and we're using it almost every day now!",
    rating: 4
  },
  {
    name: "Prashanth Kumar",
    comment: "We've signed a monthly maintenance contract with them for our apartment complex pool. Water quality has been consistently great, and their service team is punctual and well-trained. Highly recommended for anyone looking for reliable pool upkeep.",
    rating: 5
  },
  {
    name:"Niharika S",
    comment:"I wanted an infinity pool for my farmhouse and had a very specific vision in mind. The team was open to ideas and worked with my architect perfectly. The result is stunning—looks like something out of a resort. Extremely happy with the finish.",
    rating: 5
  }
];
